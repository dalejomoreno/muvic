  ...
  <main class="main">
    ...
    <div class="container">
      ...
      <div class="subcontainer">
        <form class="block" id="moving" method="POST" onsubmit="redirect()">
        ...
        <!-- Transporting Tap -->
        <form class="block" id="transporting" method="POST">
          ...
          <div>
            ...
            <input class="block-input" type="text" name="transporting_input_label" placeholder="Departing from"
              required>
          </div>
          ...
          <div>
            ...
            <input class="block-input" type="text" name="transporting_description"
              placeholder="e.g.: Stove,bed, couch, etc." required>
          </div>
          <button class="button" type="submit" name="register2">Submit</button>
        </form>
        <!-- Commuting Tap -->
        <form class="block" id="commuting" method="POST">
          <h3 class="block-h3">Commuting always available in Toronto and Surrounding Areas</h3>
          <div>
            <label class="subcontainer-label">Pick Up Location*</label>
            <input class="block-input" type="text" name="commuting_input_label" placeholder="Departing from" required>
          </div>

          <div>
            <label class="subcontainer-label">Drop Off Location*</label>
            <input class="block-input" type="text" name="commuting_input_label2" placeholder="Arriving at" required>
          </div>

          <div>
            <label class="subcontainer-label">Pick Up Date*</label>
            <input class="block-input short" type="date" id="date2" name="commuting_date" required>
          </div>

          <div>
            <label class="subcontainer-label">How many people?</label>
            <input class="block-input short" list="people" name="commuting_people">
            <datalist id="people2" required>
              <option value="0"></option>
              <option value="1"></option>
              <option value="2"></option>
  ...
  <footer class="footer">
    ...
    <div class="footer subcontainer-short">
      ...
      <form class="form-footer">
        ...
        <button class="button" type="submit" name="pending">Submit</button>
      </form>
    </div>
    ...
    <div class="footer subcontainer-long">
      ...
      <ul class="footer-div-rrss">
        ...
        <a class="footer-a" href="https://bit.ly/mudanzas247" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="footer-svg"
            viewBox="0 0 16 16">
            <path
